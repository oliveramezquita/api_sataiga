...
urlpatterns = [
    ...
    path('purchase_orders/get_projects',
         ListProjectsView.as_view(), name='projects'),
    ...
    path('after_sales/customers', CustomersView.as_view(), name='customers'),
    path('after_sales/customer/<str:id>',
         CustomerByIdView.as_view(), name='customer'),
    path('after_sales/customer/<str:action>/<str:id>',
         CustomerStatusView.as_view(), name='manage customer status'),
    ...
    path('after_sales/warranty/<str:action>/<str:id>',
         WarrantyAvailabilityView.as_view(), name='warranty availability'),
    ...
    path('after_sales/technician/<str:action>/<str:id>',
         TechnicianStatusView.as_view(), name='manage technician status'),
